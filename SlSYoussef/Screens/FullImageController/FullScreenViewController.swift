...
class FullScreenViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        DispatchQueue.main.async {
            //            self.pageController.updateDots()
        }
    }
...
class PageControl: UIStackView {
    ...
    @IBInspectable var currentPageImage: UIImage = #imageLiteral(resourceName: "selectepage")
    @IBInspectable var pageImage: UIImage = #imageLiteral(resourceName: "unselected")
    /**
